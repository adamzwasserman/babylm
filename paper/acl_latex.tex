...
A cross-lingual GLUE protocol that combines French task-data translation with rank-16 LoRA produces a sharp task-type gradient: relational tasks gain measurably, while world-knowledge tasks regress. Bilingual Lexicon Induction aligns the French embeddings to GPT-2 at p@1 = $68.84 \pm 8.61$\%, $32\times$ above chance, suggesting cross-lingual alignment tracks acquired grammatical competence rather than training duration. 
